...
public class DayOrdinalityTest {
    ...
    @Test
    public void theTwentyThird() {
        assertThat(Day.fromBase10(23).toOrdinalString(), is("23rd"));
    }

    @Test
    public void theThirtyFirst() {
        assertThat(Day.fromBase10(31).toOrdinalString(), is("31st"));
    }
